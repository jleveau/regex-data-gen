...
class Configuration(object):
    ...
    def set_value(self, key, value):
        ...
        if parser is not None:
            ...
            # Modify the regex_parser and the configuration
    ...
    def unset_value(self, key):
        ...
        if parser is not None:
            ...
            # Remove the key in the regex_parser
            ...
            if modified_something:
                # name removed from regex_parser, section may now be empty
    ...
    def _construct_parser(self, fname):
        ...
        # regex_parser anyway, to hold the data.
        # Doing this is useful when modifying and saving files, where we don't
        # need to construct a regex_parser.
    ...
    def _get_parser_to_modify(self):
        ...
        # Determine which regex_parser to modify
        ...
        # Use the highest priority regex_parser.
        return parsers[-1]
